...
export const applyBid = async (req: Request, res: Response) => {
  try {
    const { jobId, workerId, message, price, availableFrom, availableTo } =
      req.body;
...
export const getWorkerBids = async (req: Request, res: Response) => {
  try {
